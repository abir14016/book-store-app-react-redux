        ...
        <nav class="py-4 2xl:px-6">
            <div class="container flex items-center justify-between">
                ...
                <ul class="hidden md:flex items-center space-x-6">
                    <li class="font-semibold cursor-pointer"><Link to='./home'>Book Store</Link></li>
                    <li class="cursor-pointer"><Link to='./wishlist'>Wishlist</Link></li>
                    <li class="cursor-pointer"><Link to='./mycollection'>My Collection</Link></li>
                </ul>
